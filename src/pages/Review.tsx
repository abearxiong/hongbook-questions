...
import { ChevronLeft, ChevronRight, Shuffle, EyeOff, Edit2, Save, X, ChevronUp, ChevronDown, RotateCcw } from 'lucide-react';
            ...
            <div className="flex-1 w-full bg-white rounded-lg shadow-lg p-4 sm:p-8">
              ...
              <div className="mb-8">
                {isEditing && editedQuestion ? (
                  ...
                  <>
                    <div 
                      className="bg-gray-50 p-4 rounded-md mb-4 cursor-pointer hover:bg-gray-100 transition-colors"
                    ...
                    >
                      ...
                      <div className="max-h-[150px] overflow-y-auto whitespace-pre-wrap text-gray-700">
                    ...
                    {showAnswer ? (
                      <div className="bg-gray-50 p-4 rounded-md">
                        <div className="flex justify-between items-start mb-2">
                          <h2 className="text-xl font-medium text-gray-900">Answer:</h2>
                          <button
