...
import { HelpCircle, X, Copy, Check, Download, Github } from 'lucide-react';
...
2. Who invented the telephone?
   Answer: Alexander Graham Bell</pre>
                </div>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                ...
                <pre className="bg-gray-50 p-3 rounded-md text-sm text-gray-600 whitespace-pre-wrap">
{stringify({ questions: EXAMPLE_QUESTIONS })}</pre>
              </div>
            </div>
          ) : (
            <div className="space-y-6">
